...
class Modal extends Component {
  ...
  addStock = () => {
    ...
    if (
      document.getElementById("noShares").value === "" ||
      ...
      let profitLoss =
        (this.props.currentPrice - this.state.buy_price) *
        this.state.no_of_shares;
      ...
      axios.delete(
        `https://burger-app-8f654.firebaseio.com/companyStock/${this.props.stockKey}.json`
      );
  ...
  render() {
    return (
      <div>
        ...
        >
          <h2>Add {this.props.stockName} to My Stocks</h2> <br />
          <br />
          <form>
            <label htmlFor="name">
              {" "}
            ...
            : <strong>{this.props.stockName}</strong>
            <br />
            <br />
            <label htmlFor="name">
