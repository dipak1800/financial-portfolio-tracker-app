...
class Stocks extends Component {
  ...
  componentDidMount() {
    axios.get(`https://ga-fpt.firebaseio.com/allStocks.json`).then((res) => {
  ...
  postData = (e) => {
    ...
    axios
      .post("https://ga-fpt.firebaseio.com/active.json", {
