...
class AlphaCall extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${symbol}&outputsize=compact&apikey=XGVQUV2Z5VMGJYAU`
      )
      .then((res) => {
      ...
      .catch((error) => {
        ...
        alert(
          'API CALL ERROR, Please Try with different "Buy Date" or Wait for sometime and Try again.'
        );
      });
  }
